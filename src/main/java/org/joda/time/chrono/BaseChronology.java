...
public abstract class BaseChronology extends Chronology implements Serializable {
    ...
    public void validate(ReadablePartial readablePartial, int[] iArr) {
        ...
        while (i < size) {
            ...
            if (i2 < field2.getMinimumValue(readablePartial, iArr)) {
                throw new IllegalFieldValueException(field2.getType(), Integer.valueOf(i2), Integer.valueOf(field2.getMinimumValue(readablePartial, iArr)), null);
            } else if (i2 > field2.getMaximumValue(readablePartial, iArr)) {
                throw new IllegalFieldValueException(field2.getType(), Integer.valueOf(i2), null, Integer.valueOf(field2.getMaximumValue(readablePartial, iArr)));
            } else {
                i++;
            }
        }
