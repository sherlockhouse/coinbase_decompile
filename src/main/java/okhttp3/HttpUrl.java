...
public final class HttpUrl {
    ...
    private static final char[] HEX_DIGITS = new char[]{NumericKeypadConnector.ZERO, '1', '2', '3', '4', '5', '6', '7', '8', '9', 'A', 'B', 'C', 'D', 'E', 'F'};
    ...
    public static final class Builder {
        ...
        private static int schemeDelimiterOffset(String input, int pos, int limit) {
            ...
            while (i < limit) {
                ...
                if ((c >= 'a' && c <= 'z') || ((c >= 'A' && c <= 'Z') || ((c >= NumericKeypadConnector.ZERO && c <= '9') || c == '+' || c == '-' || c == NumericKeypadConnector.DOT))) {
                    i++;
                } else if (c != ':') {
                    return -1;
                } else {
        ...
        private static String canonicalizeHost(String input, int pos, int limit) {
            ...
            if (!percentDecoded.contains(CryptoUri.URI_SCHEME_DELIMETER)) {
        ...
        private static InetAddress decodeIpv6(String input, int pos, int limit) {
            ...
            while (i < limit) {
                ...
                if (i + 2 <= limit && input.regionMatches(i, "::", 0, 2)) {
                    ...
                    if (input.regionMatches(i, CryptoUri.URI_SCHEME_DELIMETER, 0, 1)) {
                        i++;
        ...
        private static boolean decodeIpv4Suffix(String input, int pos, int limit, byte[] address, int addressOffset) {
            ...
            while (i < limit) {
                ...
                if (b != addressOffset) {
                    if (input.charAt(i) != NumericKeypadConnector.DOT) {
                        return false;
                    }
                    i++;
                }
