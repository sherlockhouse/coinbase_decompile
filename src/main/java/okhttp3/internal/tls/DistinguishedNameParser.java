...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (this.end - this.beg > 4 && this.chars[this.beg + 3] == NumericKeypadConnector.DOT && ((this.chars[this.beg] == 'O' || this.chars[this.beg] == 'o') && ((this.chars[this.beg + 1] == 'I' || this.chars[this.beg + 1] == 'i') && (this.chars[this.beg + 2] == 'D' || this.chars[this.beg + 2] == 'd')))) {
            this.beg += 4;
        }
