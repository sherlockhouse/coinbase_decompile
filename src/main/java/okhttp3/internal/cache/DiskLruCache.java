...
public final class DiskLruCache implements Closeable, Flushable {
        ...
        public Sink newSink(int index) {
            ...
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        access$900 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
    ...
    private final class Entry {
        ...
        private Entry(String key) {
            ...
            StringBuilder fileBuilder = new StringBuilder(key).append(NumericKeypadConnector.DOT);
