...
public final class RealConnection extends Listener implements Connection {
    ...
    public String toString() {
        return "Connection{" + this.route.address().url().host() + CryptoUri.URI_SCHEME_DELIMETER + this.route.address().url().port() + ", proxy=" + this.route.proxy() + " hostAddress=" + this.route.socketAddress() + " cipherSuite=" + (this.handshake != null ? this.handshake.cipherSuite() : ApiConstants.NONE) + " protocol=" + this.protocol + '}';
    }
}
