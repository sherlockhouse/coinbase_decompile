...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2 {
    ...
    private String getFullClassName(Context context, String className) {
        if (className.charAt(0) == NumericKeypadConnector.DOT) {
            return context.getPackageName() + className;
        }
        return !className.contains(".") ? RecyclerView.class.getPackage().getName() + NumericKeypadConnector.DOT + className : className;
    }
