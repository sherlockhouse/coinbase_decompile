...
public class TypefaceCompat {
    ...
    public static Typeface createFromResourcesFamilyXml(Context context, FamilyResourceEntry entry, Resources resources, int id, int style, TextView targetView) {
        Typeface typeface;
