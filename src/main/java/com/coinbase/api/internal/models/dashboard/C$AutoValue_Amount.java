...
abstract class C$AutoValue_Amount extends Amount {
    ...
    static final class Builder extends com.coinbase.api.internal.models.dashboard.Amount.Builder {
        ...
        public com.coinbase.api.internal.models.dashboard.Amount.Builder setAmount(String amount) {
            this.amount = amount;
            return this;
        }

        public com.coinbase.api.internal.models.dashboard.Amount.Builder setCurrency(String currency) {
