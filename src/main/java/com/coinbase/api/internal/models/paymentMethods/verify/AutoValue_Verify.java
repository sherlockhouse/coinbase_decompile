...
final class AutoValue_Verify extends C$AutoValue_Verify {

    public static final class GsonTypeAdapter extends TypeAdapter<Verify> {
        ...
        public void write(JsonWriter jsonWriter, Verify object) throws IOException {
            if (object == null) {
        ...
        public Verify read(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_Verify(data);
        }
    }

    AutoValue_Verify(Data data) {
        super(data);
    }
}
