...
final class AutoValue_Ios extends C$AutoValue_Ios {

    public static final class GsonTypeAdapter extends TypeAdapter<Ios> {
        ...
        public void write(JsonWriter jsonWriter, Ios object) throws IOException {
            if (object == null) {
        ...
        public Ios read(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_Ios(version, message);
        }
    }

    AutoValue_Ios(Message version, Message message) {
