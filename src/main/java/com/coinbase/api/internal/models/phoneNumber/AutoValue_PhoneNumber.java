...
final class AutoValue_PhoneNumber extends C$AutoValue_PhoneNumber {
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<PhoneNumber> {
        ...
        public void write(JsonWriter jsonWriter, PhoneNumber object) throws IOException {
            if (object == null) {
        ...
        public PhoneNumber read(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_PhoneNumber(data);
        }
    }

    AutoValue_PhoneNumber(Data data) {
        super(data);
    }
}
