...
final class AutoValue_Idology extends C$AutoValue_Idology {

    public static final class GsonTypeAdapter extends TypeAdapter<Idology> {
        ...
        public void write(JsonWriter jsonWriter, Idology object) throws IOException {
            if (object == null) {
        ...
        public Idology read(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_Idology(data);
        }
    }

    AutoValue_Idology(Data data) {
        super(data);
    }
}
