...
public final class DashboardCurrencyController_MembersInjector implements MembersInjector<DashboardCurrencyController> {
    ...
    private final Provider<DashboardCurrencyPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public DashboardCurrencyController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<DashboardCurrencyPresenter> mPresenterProvider, Provider<BottomNavigationConnector> mBottomNavigationConnectorProvider) {
    ...
    public static MembersInjector<DashboardCurrencyController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<DashboardCurrencyPresenter> mPresenterProvider, Provider<BottomNavigationConnector> mBottomNavigationConnectorProvider) {
        return new DashboardCurrencyController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider, mBottomNavigationConnectorProvider);
    }

    public void injectMembers(DashboardCurrencyController instance) {
        ...
        injectMPresenter(instance, (DashboardCurrencyPresenter) this.mPresenterProvider.get());
        injectMBottomNavigationConnector(instance, (BottomNavigationConnector) this.mBottomNavigationConnectorProvider.get());
    }

    public static void injectMPresenter(DashboardCurrencyController instance, DashboardCurrencyPresenter mPresenter) {
        instance.mPresenter = mPresenter;
    }

    public static void injectMBottomNavigationConnector(DashboardCurrencyController instance, BottomNavigationConnector mBottomNavigationConnector) {
