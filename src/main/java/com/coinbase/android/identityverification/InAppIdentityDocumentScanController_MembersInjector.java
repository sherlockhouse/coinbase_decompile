...
public final class InAppIdentityDocumentScanController_MembersInjector implements MembersInjector<InAppIdentityDocumentScanController> {
    ...
    private final Provider<JumioDocumentScanPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public InAppIdentityDocumentScanController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<JumioDocumentScanPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<InAppIdentityDocumentScanController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<JumioDocumentScanPresenter> mPresenterProvider) {
        return new InAppIdentityDocumentScanController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(InAppIdentityDocumentScanController instance) {
        ...
        injectMPresenter(instance, (JumioDocumentScanPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(InAppIdentityDocumentScanController instance, JumioDocumentScanPresenter mPresenter) {
