...
public final class InAppIdentityAcceptableDocumentsController_MembersInjector implements MembersInjector<InAppIdentityAcceptableDocumentsController> {
    ...
    private final Provider<InAppIdentityAcceptableDocumentsPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public InAppIdentityAcceptableDocumentsController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<InAppIdentityAcceptableDocumentsPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<InAppIdentityAcceptableDocumentsController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<InAppIdentityAcceptableDocumentsPresenter> mPresenterProvider) {
        return new InAppIdentityAcceptableDocumentsController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(InAppIdentityAcceptableDocumentsController instance) {
        ...
        injectMPresenter(instance, (InAppIdentityAcceptableDocumentsPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(InAppIdentityAcceptableDocumentsController instance, InAppIdentityAcceptableDocumentsPresenter mPresenter) {
