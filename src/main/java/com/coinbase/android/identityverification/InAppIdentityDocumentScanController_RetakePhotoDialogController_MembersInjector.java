...
public final class InAppIdentityDocumentScanController_RetakePhotoDialogController_MembersInjector implements MembersInjector<RetakePhotoDialogController> {
    ...
    private final Provider<RetakeAndContinueConnector> mConnectorProvider;
    ...
    public InAppIdentityDocumentScanController_RetakePhotoDialogController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<BackgroundDimmer> mBackgroundDimmerProvider, Provider<RetakeAndContinueConnector> mConnectorProvider) {
    ...
    public static MembersInjector<RetakePhotoDialogController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<BackgroundDimmer> mBackgroundDimmerProvider, Provider<RetakeAndContinueConnector> mConnectorProvider) {
        return new InAppIdentityDocumentScanController_RetakePhotoDialogController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mBackgroundDimmerProvider, mConnectorProvider);
    }

    public void injectMembers(RetakePhotoDialogController instance) {
        ...
        injectMConnector(instance, (RetakeAndContinueConnector) this.mConnectorProvider.get());
    }

    public static void injectMConnector(RetakePhotoDialogController instance, RetakeAndContinueConnector mConnector) {
