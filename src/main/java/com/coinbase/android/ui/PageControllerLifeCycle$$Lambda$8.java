...
final /* synthetic */ class PageControllerLifeCycle$$Lambda$8 implements Func1 {
    private final PageControllerLifeCycle arg$1;

    private PageControllerLifeCycle$$Lambda$8(PageControllerLifeCycle pageControllerLifeCycle) {
        this.arg$1 = pageControllerLifeCycle;
    }

    public static Func1 lambdaFactory$(PageControllerLifeCycle pageControllerLifeCycle) {
        return new PageControllerLifeCycle$$Lambda$8(pageControllerLifeCycle);
    }
