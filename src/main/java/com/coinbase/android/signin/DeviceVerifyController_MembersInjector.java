...
public final class DeviceVerifyController_MembersInjector implements MembersInjector<DeviceVerifyController> {
    ...
    private final Provider<DeviceVerifyPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public DeviceVerifyController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<DeviceVerifyPresenter> mPresenterProvider, Provider<AnimationUtilsWrapper> mAnimationUtilsWrapperProvider) {
    ...
    public static MembersInjector<DeviceVerifyController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<DeviceVerifyPresenter> mPresenterProvider, Provider<AnimationUtilsWrapper> mAnimationUtilsWrapperProvider) {
        return new DeviceVerifyController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider, mAnimationUtilsWrapperProvider);
    }

    public void injectMembers(DeviceVerifyController instance) {
        ...
        injectMPresenter(instance, (DeviceVerifyPresenter) this.mPresenterProvider.get());
        injectMAnimationUtilsWrapper(instance, (AnimationUtilsWrapper) this.mAnimationUtilsWrapperProvider.get());
    }

    public static void injectMPresenter(DeviceVerifyController instance, DeviceVerifyPresenter mPresenter) {
        instance.mPresenter = mPresenter;
    }

    public static void injectMAnimationUtilsWrapper(DeviceVerifyController instance, AnimationUtilsWrapper mAnimationUtilsWrapper) {
