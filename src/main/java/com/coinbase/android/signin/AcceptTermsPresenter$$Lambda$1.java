...
final /* synthetic */ class AcceptTermsPresenter$$Lambda$1 implements Action0 {
    private final AcceptTermsPresenter arg$1;

    private AcceptTermsPresenter$$Lambda$1(AcceptTermsPresenter acceptTermsPresenter) {
        this.arg$1 = acceptTermsPresenter;
    }

    public static Action0 lambdaFactory$(AcceptTermsPresenter acceptTermsPresenter) {
        return new AcceptTermsPresenter$$Lambda$1(acceptTermsPresenter);
    }
