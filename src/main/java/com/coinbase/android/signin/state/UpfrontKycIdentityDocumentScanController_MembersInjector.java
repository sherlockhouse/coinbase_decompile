...
public final class UpfrontKycIdentityDocumentScanController_MembersInjector implements MembersInjector<UpfrontKycIdentityDocumentScanController> {
    ...
    private final Provider<UpfrontKycIdentityDocumentScanPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public UpfrontKycIdentityDocumentScanController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycIdentityDocumentScanPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<UpfrontKycIdentityDocumentScanController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycIdentityDocumentScanPresenter> mPresenterProvider) {
        return new UpfrontKycIdentityDocumentScanController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(UpfrontKycIdentityDocumentScanController instance) {
        ...
        injectMPresenter(instance, (UpfrontKycIdentityDocumentScanPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(UpfrontKycIdentityDocumentScanController instance, UpfrontKycIdentityDocumentScanPresenter mPresenter) {
