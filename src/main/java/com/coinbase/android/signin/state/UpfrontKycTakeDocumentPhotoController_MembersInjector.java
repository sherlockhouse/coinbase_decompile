...
public final class UpfrontKycTakeDocumentPhotoController_MembersInjector implements MembersInjector<UpfrontKycTakeDocumentPhotoController> {
    ...
    private final Provider<UpfrontKycTakeDocumentPhotoPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public UpfrontKycTakeDocumentPhotoController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycTakeDocumentPhotoPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<UpfrontKycTakeDocumentPhotoController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycTakeDocumentPhotoPresenter> mPresenterProvider) {
        return new UpfrontKycTakeDocumentPhotoController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(UpfrontKycTakeDocumentPhotoController instance) {
        ...
        injectMPresenter(instance, (UpfrontKycTakeDocumentPhotoPresenter) this.mPresenterProvider.get());
        injectMBackNavigationConnector(instance, (BackNavigationConnector) this.mBackNavigationConnectorProvider.get());
    }

    public static void injectMPresenter(UpfrontKycTakeDocumentPhotoController instance, UpfrontKycTakeDocumentPhotoPresenter mPresenter) {
        instance.mPresenter = mPresenter;
    }

    public static void injectMBackNavigationConnector(UpfrontKycTakeDocumentPhotoController instance, BackNavigationConnector mBackNavigationConnector) {
