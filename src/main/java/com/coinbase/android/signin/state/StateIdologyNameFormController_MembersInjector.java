...
public final class StateIdologyNameFormController_MembersInjector implements MembersInjector<StateIdologyNameFormController> {
    ...
    private final Provider<StateIdologyNameFormPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public StateIdologyNameFormController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyNameFormPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<StateIdologyNameFormController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyNameFormPresenter> mPresenterProvider) {
        return new StateIdologyNameFormController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(StateIdologyNameFormController instance) {
        ...
        injectMPresenter(instance, (StateIdologyNameFormPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(StateIdologyNameFormController instance, StateIdologyNameFormPresenter mPresenter) {
