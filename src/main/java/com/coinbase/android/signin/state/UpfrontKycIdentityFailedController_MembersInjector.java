...
public final class UpfrontKycIdentityFailedController_MembersInjector implements MembersInjector<UpfrontKycIdentityFailedController> {
    ...
    private final Provider<UpfrontKycIdentityFailedPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public UpfrontKycIdentityFailedController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycIdentityFailedPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<UpfrontKycIdentityFailedController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycIdentityFailedPresenter> mPresenterProvider) {
        return new UpfrontKycIdentityFailedController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(UpfrontKycIdentityFailedController instance) {
        ...
        injectMPresenter(instance, (UpfrontKycIdentityFailedPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(UpfrontKycIdentityFailedController instance, UpfrontKycIdentityFailedPresenter mPresenter) {
