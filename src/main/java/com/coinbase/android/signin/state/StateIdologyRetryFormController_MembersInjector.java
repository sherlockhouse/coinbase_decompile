...
public final class StateIdologyRetryFormController_MembersInjector implements MembersInjector<StateIdologyRetryFormController> {
    ...
    private final Provider<StateIdologyRetryFormPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public StateIdologyRetryFormController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyRetryFormPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<StateIdologyRetryFormController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyRetryFormPresenter> mPresenterProvider) {
        return new StateIdologyRetryFormController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(StateIdologyRetryFormController instance) {
        ...
        injectMPresenter(instance, (StateIdologyRetryFormPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(StateIdologyRetryFormController instance, StateIdologyRetryFormPresenter mPresenter) {
