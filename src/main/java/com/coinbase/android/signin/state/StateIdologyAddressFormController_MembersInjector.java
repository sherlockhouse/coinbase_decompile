...
public final class StateIdologyAddressFormController_MembersInjector implements MembersInjector<StateIdologyAddressFormController> {
    ...
    private final Provider<StateIdologyAddressFormPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public StateIdologyAddressFormController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyAddressFormPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<StateIdologyAddressFormController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyAddressFormPresenter> mPresenterProvider) {
        return new StateIdologyAddressFormController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(StateIdologyAddressFormController instance) {
        ...
        injectMPresenter(instance, (StateIdologyAddressFormPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(StateIdologyAddressFormController instance, StateIdologyAddressFormPresenter mPresenter) {
