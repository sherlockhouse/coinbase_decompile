...
public final class UpfrontKycIdentityAcceptableDocumentsController_MembersInjector implements MembersInjector<UpfrontKycIdentityAcceptableDocumentsController> {
    ...
    private final Provider<UpfrontKycIdentityAcceptableDocumentsPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public UpfrontKycIdentityAcceptableDocumentsController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycIdentityAcceptableDocumentsPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<UpfrontKycIdentityAcceptableDocumentsController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<UpfrontKycIdentityAcceptableDocumentsPresenter> mPresenterProvider) {
        return new UpfrontKycIdentityAcceptableDocumentsController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(UpfrontKycIdentityAcceptableDocumentsController instance) {
        ...
        injectMPresenter(instance, (UpfrontKycIdentityAcceptableDocumentsPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(UpfrontKycIdentityAcceptableDocumentsController instance, UpfrontKycIdentityAcceptableDocumentsPresenter mPresenter) {
