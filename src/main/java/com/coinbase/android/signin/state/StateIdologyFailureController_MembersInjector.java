...
public final class StateIdologyFailureController_MembersInjector implements MembersInjector<StateIdologyFailureController> {
    ...
    private final Provider<StateIdologyFailurePresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public StateIdologyFailureController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyFailurePresenter> mPresenterProvider) {
    ...
    public static MembersInjector<StateIdologyFailureController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<StateIdologyFailurePresenter> mPresenterProvider) {
        return new StateIdologyFailureController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(StateIdologyFailureController instance) {
        ...
        injectMPresenter(instance, (StateIdologyFailurePresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(StateIdologyFailureController instance, StateIdologyFailurePresenter mPresenter) {
