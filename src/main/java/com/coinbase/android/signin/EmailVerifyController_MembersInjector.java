...
public final class EmailVerifyController_MembersInjector implements MembersInjector<EmailVerifyController> {
    ...
    private final Provider<EmailVerifyPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public EmailVerifyController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<EmailVerifyPresenter> mPresenterProvider, Provider<AnimationUtilsWrapper> mAnimationUtilsWrapperProvider) {
    ...
    public static MembersInjector<EmailVerifyController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<EmailVerifyPresenter> mPresenterProvider, Provider<AnimationUtilsWrapper> mAnimationUtilsWrapperProvider) {
        return new EmailVerifyController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider, mAnimationUtilsWrapperProvider);
    }

    public void injectMembers(EmailVerifyController instance) {
        ...
        injectMPresenter(instance, (EmailVerifyPresenter) this.mPresenterProvider.get());
        injectMAnimationUtilsWrapper(instance, (AnimationUtilsWrapper) this.mAnimationUtilsWrapperProvider.get());
    }

    public static void injectMPresenter(EmailVerifyController instance, EmailVerifyPresenter mPresenter) {
        instance.mPresenter = mPresenter;
    }

    public static void injectMAnimationUtilsWrapper(EmailVerifyController instance, AnimationUtilsWrapper mAnimationUtilsWrapper) {
