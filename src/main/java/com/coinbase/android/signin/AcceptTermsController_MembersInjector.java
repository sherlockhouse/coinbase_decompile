...
public final class AcceptTermsController_MembersInjector implements MembersInjector<AcceptTermsController> {
    private final Provider<AcceptTermsPresenter> mAcceptTermsPresenterProvider;
    ...
    public AcceptTermsController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AcceptTermsPresenter> mAcceptTermsPresenterProvider) {
        ...
        this.mAcceptTermsPresenterProvider = mAcceptTermsPresenterProvider;
    }

    public static MembersInjector<AcceptTermsController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AcceptTermsPresenter> mAcceptTermsPresenterProvider) {
        return new AcceptTermsController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mAcceptTermsPresenterProvider);
    }

    public void injectMembers(AcceptTermsController instance) {
        ...
        injectMAcceptTermsPresenter(instance, (AcceptTermsPresenter) this.mAcceptTermsPresenterProvider.get());
    }

    public static void injectMAcceptTermsPresenter(AcceptTermsController instance, AcceptTermsPresenter mAcceptTermsPresenter) {
        instance.mAcceptTermsPresenter = mAcceptTermsPresenter;
    }
}
