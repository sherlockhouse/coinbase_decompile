...
public final class WithdrawFiatConfirmationController_MembersInjector implements MembersInjector<WithdrawFiatConfirmationController> {
    ...
    private final Provider<WithdrawConfirmationPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public WithdrawFiatConfirmationController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<WithdrawConfirmationPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<WithdrawFiatConfirmationController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<WithdrawConfirmationPresenter> mPresenterProvider) {
        return new WithdrawFiatConfirmationController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(WithdrawFiatConfirmationController instance) {
        ...
        injectMPresenter(instance, (WithdrawConfirmationPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(WithdrawFiatConfirmationController instance, WithdrawConfirmationPresenter mPresenter) {
