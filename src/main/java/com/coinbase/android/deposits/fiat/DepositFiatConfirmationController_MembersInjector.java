...
public final class DepositFiatConfirmationController_MembersInjector implements MembersInjector<DepositFiatConfirmationController> {
    ...
    private final Provider<DepositConfirmationPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public DepositFiatConfirmationController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<DepositConfirmationPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<DepositFiatConfirmationController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<DepositConfirmationPresenter> mPresenterProvider) {
        return new DepositFiatConfirmationController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(DepositFiatConfirmationController instance) {
        ...
        injectMPresenter(instance, (DepositConfirmationPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(DepositFiatConfirmationController instance, DepositConfirmationPresenter mPresenter) {
