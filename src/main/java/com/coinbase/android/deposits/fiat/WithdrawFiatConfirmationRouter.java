...
@ControllerScope
public class WithdrawFiatConfirmationRouter {
    private ActionBarController mController;

    @Inject
    WithdrawFiatConfirmationRouter(ActionBarController actionBarController) {
    ...
    void routeToWithdrawSuccess(com.coinbase.v2.models.transfers.Data transferData, com.coinbase.v2.models.account.Data accountData) {
        Gson gson = new Gson();
