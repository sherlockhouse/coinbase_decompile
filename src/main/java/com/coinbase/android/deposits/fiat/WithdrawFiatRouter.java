...
@ControllerScope
public class WithdrawFiatRouter {
    public static final String ACCOUNT = "WITHDRAW_CONFIRMATION_ACCOUNT";
    private static final String BLOG_URL = "https://blog.coinbase.com";
    public static final String PAYMENT_METHOD = "WITHDRAW_CONFIRMATION_PAYMENT_METHOD";
    public static final String SELECTED_ACCOUNT = "selected_account";
    public static final String TRANSFER = "WITHDRAW_CONFIRMATION_TRANSFER";
    public static final String VALID_PAYMENT_METHODS = "WITHDRAW_CONFIRMATION_VALID_PAYMENT_METHOD_LIST";
    private final ActionBarController mController;

    @Inject
    public WithdrawFiatRouter(ActionBarController controller) {
    ...
    void routeToWithdrawConfirmation(com.coinbase.v2.models.transfers.Data transferData, com.coinbase.v2.models.account.Data account, Data selectedPaymentMethod, List<Data> validPaymentMethods) {
        ...
        this.mController.pushModalController(new WithdrawFiatConfirmationController(this.mController.appendModalArgs(args)));
    }
