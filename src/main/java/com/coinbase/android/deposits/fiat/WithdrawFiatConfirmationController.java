...
@ControllerScope
public class WithdrawFiatConfirmationController extends ActionBarController implements WithdrawFiatConfirmationScreen {
    private ControllerFiatConfirmationBinding mBinding;
    private ProgressDialog mDialog;
    @Inject
    WithdrawConfirmationPresenter mPresenter;

    public WithdrawFiatConfirmationController(Bundle args) {
        super(args);
    }
    ...
    protected View onCreateView(LayoutInflater inflater, ViewGroup container) {
        ...
        ((MainActivitySubcomponentProvider) getActivity()).mainActivitySubcomponent().withdrawFiatConfirmationControllerSubcomponent(new WithdrawFiatConfirmationPresenterModule(this, this)).inject(this);
        this.mBinding.btContinue.setOnClickListener(WithdrawFiatConfirmationController$$Lambda$1.lambdaFactory$(this));
    ...
    public void setWithdrawalAmount(String amount) {
