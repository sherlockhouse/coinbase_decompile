...
public class CardCdvAmountsFormBinding extends ViewDataBinding {
    ...
    private InverseBindingListener etAmount1androidTextAttrChanged = new InverseBindingListener() {
        public void onChange() {
            String callbackArg_0 = TextViewBindingAdapter.getTextString(CardCdvAmountsFormBinding.this.etAmount1);
            IAVLoginPresenter presenter = CardCdvAmountsFormBinding.this.mPresenter;
            if (presenter != null) {
                presenter.mCardAmount1 = callbackArg_0;
            }
        }
    };
    ...
    private InverseBindingListener etAmount2androidTextAttrChanged = new InverseBindingListener() {
        public void onChange() {
            String callbackArg_0 = TextViewBindingAdapter.getTextString(CardCdvAmountsFormBinding.this.etAmount2);
            IAVLoginPresenter presenter = CardCdvAmountsFormBinding.this.mPresenter;
            if (presenter != null) {
                presenter.mCardAmount2 = callbackArg_0;
            }
        }
    };
    ...
    public CardCdvAmountsFormBinding(DataBindingComponent bindingComponent, View root) {
    ...
    protected void executeBindings() {
        ...
        String presenterMCardAmount1 = null;
        String presenterMCardAmount2 = null;
        if (!((dirtyFlags & 3) == 0 || presenter == null)) {
            presenterMCardAmount1 = presenter.mCardAmount1;
            presenterMCardAmount2 = presenter.mCardAmount2;
        }
        if ((dirtyFlags & 3) != 0) {
            TextViewBindingAdapter.setText(this.etAmount1, presenterMCardAmount1);
            TextViewBindingAdapter.setText(this.etAmount2, presenterMCardAmount2);
        }
        if ((2 & dirtyFlags) != 0) {
    ...
    public static CardCdvAmountsFormBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    public static CardCdvAmountsFormBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, DataBindingComponent bindingComponent) {
        return (CardCdvAmountsFormBinding) DataBindingUtil.inflate(inflater, R.layout.card_cdv_amounts_form, root, attachToRoot, bindingComponent);
    }

    public static CardCdvAmountsFormBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    public static CardCdvAmountsFormBinding inflate(LayoutInflater inflater, DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(R.layout.card_cdv_amounts_form, null, false), bindingComponent);
    }

    public static CardCdvAmountsFormBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    public static CardCdvAmountsFormBinding bind(View view, DataBindingComponent bindingComponent) {
        if ("layout/card_cdv_amounts_form_0".equals(view.getTag())) {
            return new CardCdvAmountsFormBinding(bindingComponent, view);
        }
