...
public class LayoutNumericKeyboardBinding extends ViewDataBinding {
    private static final IncludedLayouts sIncludes = null;
    private static final SparseIntArray sViewsWithIds = new SparseIntArray();
    public final ImageView ivAmountKeyboardRight;
    ...
    public final TextView tvAmountKeyboardLeft;
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvAmountKeyboardLeft, 10);
        sViewsWithIds.put(R.id.tvAmountKeyboard0, 11);
        sViewsWithIds.put(R.id.ivAmountKeyboardRight, 12);
    }

    public LayoutNumericKeyboardBinding(DataBindingComponent bindingComponent, View root) {
        super(bindingComponent, root, 0);
        Object[] bindings = ViewDataBinding.mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds);
        this.ivAmountKeyboardRight = (ImageView) bindings[12];
        ...
        this.tvAmountKeyboardLeft = (TextView) bindings[10];
        setRootTag(root);
        invalidateAll();
    }
    ...
    public static LayoutNumericKeyboardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    public static LayoutNumericKeyboardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, DataBindingComponent bindingComponent) {
        return (LayoutNumericKeyboardBinding) DataBindingUtil.inflate(inflater, R.layout.layout_numeric_keyboard, root, attachToRoot, bindingComponent);
    }

    public static LayoutNumericKeyboardBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    public static LayoutNumericKeyboardBinding inflate(LayoutInflater inflater, DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(R.layout.layout_numeric_keyboard, null, false), bindingComponent);
    }
    ...
    public static LayoutNumericKeyboardBinding bind(View view, DataBindingComponent bindingComponent) {
        if ("layout/layout_numeric_keyboard_0".equals(view.getTag())) {
            return new LayoutNumericKeyboardBinding(bindingComponent, view);
        }
