...
public class ControllerIdentityVerificationBindingLargeLandImpl extends ControllerIdentityVerificationBinding {
    ...
    public ControllerIdentityVerificationBindingLargeLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ControllerIdentityVerificationBindingLargeLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
