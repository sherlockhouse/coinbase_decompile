...
public class FragmentPlaidAccountLoginBindingLargeLandImpl extends FragmentPlaidAccountLoginBinding {
    ...
    static {
        sIncludes.setIncludes(1, new String[]{"fragment_plaid_account_login_content"}, new int[]{2}, new int[]{R.layout.fragment_plaid_account_login_content});
    }

    public FragmentPlaidAccountLoginBindingLargeLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private FragmentPlaidAccountLoginBindingLargeLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (FragmentPlaidAccountLoginContentBinding) bindings[2]);
        this.mDirtyFlags = -1;
