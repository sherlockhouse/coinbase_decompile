...
public class ControllerAcceptableDocumentsBindingImpl extends ControllerAcceptableDocumentsBinding {
    ...
    public ControllerAcceptableDocumentsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ControllerAcceptableDocumentsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
