...
public class ControllerIdentityDocumentScanBindingImpl extends ControllerIdentityDocumentScanBinding {
    ...
    public ControllerIdentityDocumentScanBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ControllerIdentityDocumentScanBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
