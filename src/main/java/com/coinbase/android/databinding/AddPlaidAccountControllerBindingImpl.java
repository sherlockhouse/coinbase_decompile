...
public class AddPlaidAccountControllerBindingImpl extends AddPlaidAccountControllerBinding {
    ...
    public AddPlaidAccountControllerBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private AddPlaidAccountControllerBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
