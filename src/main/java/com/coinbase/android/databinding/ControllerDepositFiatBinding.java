...
public class ControllerDepositFiatBinding extends ViewDataBinding {
    ...
    public final RelativeLayout rlDepositContent;
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rlDepositContent, 3);
    ...
    public ControllerDepositFiatBinding(DataBindingComponent bindingComponent, View root) {
        ...
        this.rlDepositContent = (RelativeLayout) bindings[3];
    ...
    public static ControllerDepositFiatBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    public static ControllerDepositFiatBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, DataBindingComponent bindingComponent) {
        return (ControllerDepositFiatBinding) DataBindingUtil.inflate(inflater, R.layout.controller_deposit_fiat, root, attachToRoot, bindingComponent);
    }

    public static ControllerDepositFiatBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    public static ControllerDepositFiatBinding inflate(LayoutInflater inflater, DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(R.layout.controller_deposit_fiat, null, false), bindingComponent);
    }

    public static ControllerDepositFiatBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    public static ControllerDepositFiatBinding bind(View view, DataBindingComponent bindingComponent) {
        if ("layout/controller_deposit_fiat_0".equals(view.getTag())) {
            return new ControllerDepositFiatBinding(bindingComponent, view);
        }
