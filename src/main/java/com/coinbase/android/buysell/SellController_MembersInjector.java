...
public final class SellController_MembersInjector implements MembersInjector<SellController> {
    ...
    private final Provider<SellPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public SellController_MembersInjector(Provider<AppCompatActivity> mActivityAndMAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<SellPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<SellController> create(Provider<AppCompatActivity> mActivityAndMAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<SellPresenter> mPresenterProvider) {
        return new SellController_MembersInjector(mActivityAndMAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(SellController instance) {
        ...
        injectMPresenter(instance, this.mPresenterProvider.get());
        injectMActivity(instance, (AppCompatActivity) this.mActivityAndMAppCompatActivityProvider.get());
    }

    public static void injectMPresenter(SellController instance, Object mPresenter) {
        instance.mPresenter = (SellPresenter) mPresenter;
    }

    public static void injectMActivity(SellController instance, AppCompatActivity mActivity) {
