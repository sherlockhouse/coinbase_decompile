...
final /* synthetic */ class BuyPresenter$$Lambda$21 implements Action1 {
    private final BuyPresenter arg$1;

    private BuyPresenter$$Lambda$21(BuyPresenter buyPresenter) {
        this.arg$1 = buyPresenter;
    }

    public static Action1 lambdaFactory$(BuyPresenter buyPresenter) {
        return new BuyPresenter$$Lambda$21(buyPresenter);
    }
