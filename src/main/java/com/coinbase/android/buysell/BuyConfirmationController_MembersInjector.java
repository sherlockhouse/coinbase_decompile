...
public final class BuyConfirmationController_MembersInjector implements MembersInjector<BuyConfirmationController> {
    ...
    private final Provider<BuyConfirmationPresenter> mPresenterProvider2;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public BuyConfirmationController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider, Provider<BuyConfirmationPresenter> mPresenterProvider2) {
    ...
    public static MembersInjector<BuyConfirmationController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider, Provider<BuyConfirmationPresenter> mPresenterProvider2) {
        return new BuyConfirmationController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider, mPresenterProvider2);
    }

    public void injectMembers(BuyConfirmationController instance) {
        ...
        injectMPresenter(instance, (BuyConfirmationPresenter) this.mPresenterProvider2.get());
    }

    public static void injectMPresenter(BuyConfirmationController instance, BuyConfirmationPresenter mPresenter) {
