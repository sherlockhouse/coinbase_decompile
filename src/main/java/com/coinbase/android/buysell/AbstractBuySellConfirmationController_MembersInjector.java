...
public final class AbstractBuySellConfirmationController_MembersInjector implements MembersInjector<AbstractBuySellConfirmationController> {
    ...
    public AbstractBuySellConfirmationController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<AbstractBuySellConfirmationController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider) {
        return new AbstractBuySellConfirmationController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(AbstractBuySellConfirmationController instance) {
    ...
    public static void injectMPresenter(Object instance, Object mPresenter) {
        ((AbstractBuySellConfirmationController) instance).mPresenter = (AbstractBuySellConfirmationPresenter) mPresenter;
    }
}
