...
public final class SellConfirmationController_MembersInjector implements MembersInjector<SellConfirmationController> {
    ...
    private final Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider;
    private final Provider<SellConfirmationPresenter> mPresenterProvider2;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public SellConfirmationController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider, Provider<SellConfirmationPresenter> mPresenterProvider2) {
        ...
        this.mPresenterProvider2 = mPresenterProvider2;
    }

    public static MembersInjector<SellConfirmationController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AbstractBuySellConfirmationPresenter> mPresenterProvider, Provider<SellConfirmationPresenter> mPresenterProvider2) {
        return new SellConfirmationController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider, mPresenterProvider2);
    }

    public void injectMembers(SellConfirmationController instance) {
        ...
        AbstractBuySellConfirmationController_MembersInjector.injectMPresenter(instance, this.mPresenterProvider.get());
        injectMPresenter(instance, (SellConfirmationPresenter) this.mPresenterProvider2.get());
    }

    public static void injectMPresenter(SellConfirmationController instance, SellConfirmationPresenter mPresenter) {
