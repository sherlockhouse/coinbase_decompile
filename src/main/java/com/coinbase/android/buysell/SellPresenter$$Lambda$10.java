...
final /* synthetic */ class SellPresenter$$Lambda$10 implements Action1 {
    private final SellPresenter arg$1;

    private SellPresenter$$Lambda$10(SellPresenter sellPresenter) {
        this.arg$1 = sellPresenter;
    }

    public static Action1 lambdaFactory$(SellPresenter sellPresenter) {
        return new SellPresenter$$Lambda$10(sellPresenter);
    }
