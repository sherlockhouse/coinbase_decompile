...
public final class IdologySettingsQuestionsController_MembersInjector implements MembersInjector<IdologySettingsQuestionsController> {
    ...
    public static MembersInjector<IdologySettingsQuestionsController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<IdologySettingsQuestionsPresenter> mPresenterProvider) {
        return new IdologySettingsQuestionsController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(IdologySettingsQuestionsController instance) {
    ...
    public static void injectMPresenter(IdologySettingsQuestionsController instance, IdologySettingsQuestionsPresenter mPresenter) {
