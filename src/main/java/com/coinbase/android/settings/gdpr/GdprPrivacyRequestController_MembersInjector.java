...
public final class GdprPrivacyRequestController_MembersInjector implements MembersInjector<GdprPrivacyRequestController> {
    ...
    private final Provider<GdprPrivacyRequestPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public GdprPrivacyRequestController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprPrivacyRequestPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<GdprPrivacyRequestController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprPrivacyRequestPresenter> mPresenterProvider) {
        return new GdprPrivacyRequestController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(GdprPrivacyRequestController instance) {
        ...
        injectMPresenter(instance, (GdprPrivacyRequestPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(GdprPrivacyRequestController instance, GdprPrivacyRequestPresenter mPresenter) {
