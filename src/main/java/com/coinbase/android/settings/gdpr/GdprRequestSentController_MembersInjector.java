...
public final class GdprRequestSentController_MembersInjector implements MembersInjector<GdprRequestSentController> {
    ...
    private final Provider<GdprRequestSentPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public GdprRequestSentController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprRequestSentPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<GdprRequestSentController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprRequestSentPresenter> mPresenterProvider) {
        return new GdprRequestSentController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(GdprRequestSentController instance) {
        ...
        injectMPresenter(instance, (GdprRequestSentPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(GdprRequestSentController instance, GdprRequestSentPresenter mPresenter) {
