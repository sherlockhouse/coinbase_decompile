...
final /* synthetic */ class PrivacyRightsPresenterModule$$Lambda$2 implements Func0 {
    private final Application arg$1;
    private final SettingsPreferenceItemClickedConnector arg$2;

    private PrivacyRightsPresenterModule$$Lambda$2(Application application, SettingsPreferenceItemClickedConnector settingsPreferenceItemClickedConnector) {
    ...
    public static Func0 lambdaFactory$(Application application, SettingsPreferenceItemClickedConnector settingsPreferenceItemClickedConnector) {
        return new PrivacyRightsPresenterModule$$Lambda$2(application, settingsPreferenceItemClickedConnector);
    }

    public Object call() {
        return new RequestDataItem(this.arg$1, this.arg$2);
    }
}
