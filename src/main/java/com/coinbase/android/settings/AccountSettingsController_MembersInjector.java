...
public final class AccountSettingsController_MembersInjector implements MembersInjector<AccountSettingsController> {
    ...
    private final Provider<AccountSettingsPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public AccountSettingsController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AccountSettingsPresenter> mPresenterProvider, Provider<BottomNavigationConnector> mBottomNavigationConnectorProvider) {
    ...
    public static MembersInjector<AccountSettingsController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<AccountSettingsPresenter> mPresenterProvider, Provider<BottomNavigationConnector> mBottomNavigationConnectorProvider) {
        return new AccountSettingsController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider, mBottomNavigationConnectorProvider);
    }

    public void injectMembers(AccountSettingsController instance) {
        ...
        injectMPresenter(instance, (AccountSettingsPresenter) this.mPresenterProvider.get());
        injectMBottomNavigationConnector(instance, (BottomNavigationConnector) this.mBottomNavigationConnectorProvider.get());
    }

    public static void injectMPresenter(AccountSettingsController instance, AccountSettingsPresenter mPresenter) {
        instance.mPresenter = mPresenter;
    }

    public static void injectMBottomNavigationConnector(AccountSettingsController instance, BottomNavigationConnector mBottomNavigationConnector) {
