...
public final class InvestmentTiersRequirementsController_MembersInjector implements MembersInjector<InvestmentTiersRequirementsController> {
    ...
    private final Provider<InvestmentTiersRequirementsPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public InvestmentTiersRequirementsController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<InvestmentTiersRequirementsPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<InvestmentTiersRequirementsController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<InvestmentTiersRequirementsPresenter> mPresenterProvider) {
        return new InvestmentTiersRequirementsController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(InvestmentTiersRequirementsController instance) {
        ...
        injectMPresenter(instance, (InvestmentTiersRequirementsPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(InvestmentTiersRequirementsController instance, InvestmentTiersRequirementsPresenter mPresenter) {
