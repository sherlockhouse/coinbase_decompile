...
public final class GdprMarketingEmailController_MembersInjector implements MembersInjector<GdprMarketingEmailController> {
    ...
    private final Provider<GdprMarketingEmailPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public GdprMarketingEmailController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprMarketingEmailPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<GdprMarketingEmailController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprMarketingEmailPresenter> mPresenterProvider) {
        return new GdprMarketingEmailController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(GdprMarketingEmailController instance) {
        ...
        injectMPresenter(instance, (GdprMarketingEmailPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(GdprMarketingEmailController instance, GdprMarketingEmailPresenter mPresenter) {
