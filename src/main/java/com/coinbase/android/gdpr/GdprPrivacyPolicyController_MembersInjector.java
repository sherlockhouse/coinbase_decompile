...
public final class GdprPrivacyPolicyController_MembersInjector implements MembersInjector<GdprPrivacyPolicyController> {
    ...
    private final Provider<GdprPrivacyPolicyPresenter> mPresenterProvider;
    private final Provider<StatusBarUpdater> mStatusBarUpdaterProvider;

    public GdprPrivacyPolicyController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprPrivacyPolicyPresenter> mPresenterProvider) {
    ...
    public static MembersInjector<GdprPrivacyPolicyController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<GdprPrivacyPolicyPresenter> mPresenterProvider) {
        return new GdprPrivacyPolicyController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mPresenterProvider);
    }

    public void injectMembers(GdprPrivacyPolicyController instance) {
        ...
        injectMPresenter(instance, (GdprPrivacyPolicyPresenter) this.mPresenterProvider.get());
    }

    public static void injectMPresenter(GdprPrivacyPolicyController instance, GdprPrivacyPolicyPresenter mPresenter) {
