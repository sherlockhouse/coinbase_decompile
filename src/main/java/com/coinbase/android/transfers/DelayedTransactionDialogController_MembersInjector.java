...
public final class DelayedTransactionDialogController_MembersInjector implements MembersInjector<DelayedTransactionDialogController> {
    ...
    private final Provider<DelayedTransactionDialogPresenter> mPresenterProvider;
    ...
    public DelayedTransactionDialogController_MembersInjector(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<BackgroundDimmer> mBackgroundDimmerProvider, Provider<DelayedTransactionDialogPresenter> mPresenterProvider, Provider<SuccessRouter> mSuccessRouterProvider) {
    ...
    public static MembersInjector<DelayedTransactionDialogController> create(Provider<AppCompatActivity> mAppCompatActivityProvider, Provider<BackNavigationConnector> mBackNavigationConnectorProvider, Provider<Scheduler> mMainSchedulerProvider, Provider<StatusBarUpdater> mStatusBarUpdaterProvider, Provider<ControllerTransitionContainer> mChildTransitionBehaviorProvider, Provider<ControllerLifeCycleFactory> mLifeCycleFactoryProvider, Provider<Func0<ViewGroup>> mModalViewProvider, Provider<BackgroundDimmer> mBackgroundDimmerProvider, Provider<DelayedTransactionDialogPresenter> mPresenterProvider, Provider<SuccessRouter> mSuccessRouterProvider) {
        return new DelayedTransactionDialogController_MembersInjector(mAppCompatActivityProvider, mBackNavigationConnectorProvider, mMainSchedulerProvider, mStatusBarUpdaterProvider, mChildTransitionBehaviorProvider, mLifeCycleFactoryProvider, mModalViewProvider, mBackgroundDimmerProvider, mPresenterProvider, mSuccessRouterProvider);
    }

    public void injectMembers(DelayedTransactionDialogController instance) {
        ...
        injectMPresenter(instance, (DelayedTransactionDialogPresenter) this.mPresenterProvider.get());
        injectMSuccessRouter(instance, (SuccessRouter) this.mSuccessRouterProvider.get());
    }

    public static void injectMPresenter(DelayedTransactionDialogController instance, DelayedTransactionDialogPresenter mPresenter) {
        instance.mPresenter = mPresenter;
    }

    public static void injectMSuccessRouter(DelayedTransactionDialogController instance, SuccessRouter mSuccessRouter) {
