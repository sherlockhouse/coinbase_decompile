...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
    ...
    protected CreatorProperty constructCreatorProperty(DeserializationContext ctxt, BeanDescription beanDesc, PropertyName name, int index, AnnotatedParameter param, Object injectableValueId) throws JsonMappingException {
        ...
        Std property = new Std(name, t0, intr.findWrapperName(param), beanDesc.getClassAnnotations(), param, metadata);
        ...
        if (deser != null) {
            return prop.withValueDeserializer((JsonDeserializer) ctxt.handlePrimaryContextualization(deser, prop));
        }
        return prop;
    }
