...
public final class zzf extends Binder {
    ...
    zzf(zzb com_google_firebase_iid_zzb) {
        this.zznfa = com_google_firebase_iid_zzb;
    }
    ...
    public final void zza(zzd com_google_firebase_iid_zzd) {
        ...
        if (this.zznfa.zzo(com_google_firebase_iid_zzd.intent)) {
        ...
        this.zznfa.zzisa.execute(new zzg(this, com_google_firebase_iid_zzd));
    }
}
