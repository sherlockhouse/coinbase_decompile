...
public class StreetViewPanoramaCamera extends zzbck implements ReflectedParcelable {
    ...
    public StreetViewPanoramaCamera(float f, float f2, float f3) {
        ...
        zzbp.zzb(z, "Tilt needs to be between -90 and 90 inclusive: " + f2);
        if (((double) f) <= 0.0d) {
            f = 0.0f;
        }
        this.zoom = f;
        ...
        this.zzika = new Builder().tilt(f2).bearing(f3).build();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzbcn.zza(parcel, 2, this.zoom);
        zzbcn.zza(parcel, 3, this.tilt);
        zzbcn.zza(parcel, 4, this.bearing);
