...
public final class zzt {
    ...
    public static String zzi(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(R.string.common_google_play_services_install_text, new Object[]{zzcd});
            case 2:
                if (zzi.zzcj(context)) {
                    return resources.getString(R.string.common_google_play_services_wear_update_text);
                }
                return resources.getString(R.string.common_google_play_services_update_text, new Object[]{zzcd});
            case 3:
                return resources.getString(R.string.common_google_play_services_enable_text, new Object[]{zzcd});
            case 5:
            ...
            case 9:
                return resources.getString(R.string.common_google_play_services_unsupported_text, new Object[]{zzcd});
            case 16:
            ...
            case 18:
                return resources.getString(R.string.common_google_play_services_updating_text, new Object[]{zzcd});
            case 20:
                return zzl(context, "common_google_play_services_restricted_profile_text", zzcd);
            default:
                return resources.getString(R.string.common_google_play_services_unknown_issue, new Object[]{zzcd});
        }
    }
    ...
    private static String zzl(Context context, String str, String str2) {
        ...
        return String.format(resources.getConfiguration().locale, zzy, new Object[]{str2});
    }

    private static String zzy(Context context, String str) {
        synchronized (zzftw) {
            String str2 = (String) zzftw.get(str);
            if (str2 != null) {
                return str2;
            }
