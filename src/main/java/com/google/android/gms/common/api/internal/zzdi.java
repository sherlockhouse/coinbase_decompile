    ...
    public final void handleMessage(Message message) {
        switch (message.what) {
            case 0:
                ...
                synchronized (this.zzfpp.zzfjf) {
                    if (pendingResult == null) {
                        this.zzfpp.zzfpi.zzd(new Status(13, "Transform returned null"));
                    } else if (pendingResult instanceof zzcu) {
                        this.zzfpp.zzfpi.zzd(((zzcu) pendingResult).getStatus());
                    } else {
                        this.zzfpp.zzfpi.zza(pendingResult);
                    }
                }
                return;
            case 1:
