...
public class GoogleApiAvailability extends zze {
    ...
    class zza extends Handler {
        ...
        private /* synthetic */ GoogleApiAvailability zzffj;

        public zza(GoogleApiAvailability googleApiAvailability, Context context) {
            this.zzffj = googleApiAvailability;
        ...
        public final void handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    int isGooglePlayServicesAvailable = this.zzffj.isGooglePlayServicesAvailable(this.mApplicationContext);
                    if (this.zzffj.isUserResolvableError(isGooglePlayServicesAvailable)) {
                        this.zzffj.showErrorNotification(this.mApplicationContext, isGooglePlayServicesAvailable);
                        return;
                    }
                    return;
                default:
    ...
    static Dialog zza(Context context, int i, zzu com_google_android_gms_common_internal_zzu, OnCancelListener onCancelListener) {
        ...
        if (zzk != null) {
            builder.setPositiveButton(zzk, com_google_android_gms_common_internal_zzu);
        }
    ...
    public static zzby zza(Context context, zzbz com_google_android_gms_common_api_internal_zzbz) {
        IntentFilter intentFilter = new IntentFilter("android.intent.action.PACKAGE_ADDED");
        intentFilter.addDataScheme("package");
        BroadcastReceiver com_google_android_gms_common_api_internal_zzby = new zzby(com_google_android_gms_common_api_internal_zzbz);
        context.registerReceiver(com_google_android_gms_common_api_internal_zzby, intentFilter);
        com_google_android_gms_common_api_internal_zzby.setContext(context);
        if (zzo.zzx(context, "com.google.android.gms")) {
            return com_google_android_gms_common_api_internal_zzby;
        }
        com_google_android_gms_common_api_internal_zzbz.zzage();
        com_google_android_gms_common_api_internal_zzby.unregister();
        return null;
    }
    ...
    public final boolean zza(Activity activity, zzcg com_google_android_gms_common_api_internal_zzcg, int i, int i2, OnCancelListener onCancelListener) {
        Dialog zza = zza((Context) activity, i, zzu.zza(com_google_android_gms_common_api_internal_zzcg, zze.zza(activity, i, "d"), 2), onCancelListener);
        if (zza == null) {
            return false;
        }
