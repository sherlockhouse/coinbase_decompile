...
public final class zzbx extends Button {
    ...
    public final void zza(Resources resources, int i, int i2) {
        ...
        setTextColor((ColorStateList) zzbp.zzu(resources.getColorStateList(zzf(i2, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))));
        switch (i) {
            case 0:
