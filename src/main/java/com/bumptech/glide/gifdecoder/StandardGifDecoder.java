    ...
    private Bitmap setPixels(GifFrame currentFrame, GifFrame previousFrame) {
        ...
        if (previousFrame != null && previousFrame.dispose > 0) {
            if (previousFrame.dispose == 2) {
                ...
                int topLeft = (this.downsampledWidth * (previousFrame.iy / this.sampleSize)) + (previousFrame.ix / this.sampleSize);
                int bottomLeft = topLeft + (this.downsampledWidth * (previousFrame.ih / this.sampleSize));
                int left = topLeft;
